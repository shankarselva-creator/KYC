...
| POST | `/api/experts/backtest` | Replay a strategy over recent candles; returns a report + equity curve |
| POST | `/api/experts/optimize` | Sweep a strategy's params via backtest; returns ranked results |
